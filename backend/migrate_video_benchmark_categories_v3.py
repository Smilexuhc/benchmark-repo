...
CATEGORIES: dict[str, Category] = {
    ...
    "1.3.3": cat("1.3.3", "单镜头", "场景与空间", "人物场景融合、交互", "检查人物与门窗、墙面、家具等场景元素的遮挡、透射和穿帮是否真实"),
    "1.3.4": cat("1.3.4", "单镜头", "场景与空间", "场景可行动性", "检查场景是否像真实可使用空间，门、桌面、通道等是否可行动"),
    ...
    "1.4.1": cat("1.4.1", "单镜头", "表演与动作", "简单动作执行", "检查走路、转身、坐下、抬手等基础动作是否自然完成"),
    ...
    "1.4.5": cat("1.4.5", "单镜头", "表演与动作", "复杂动作执行", "检查奔跑、舞蹈、打斗、追逐等复杂动作是否连贯可信"),
    "1.4.10": cat("1.4.10", "单镜头", "表演与动作", "物理反馈、受力", "检查推拉、碰撞、受击、攻击等力的结果是否符合常识"),
...
ITEM_OVERRIDES: dict[int, str] = {
    ...
    45: "1.4.5",  # yoga sequence with ordered full-body movement
