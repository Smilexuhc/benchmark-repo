...
export const QUESTION_TYPE_OPTIONS: QuestionTypeOption[] = [
  node('1', '单镜头', '', [
    ...
    node('1.3', '场景与空间', '', [
      ...
      node('1.3.3', '人物场景融合和交互', '检查人物与门窗、墙面、家具、桌面、通道等场景元素的融合、遮挡、接触和交互是否真实可信'),
      node('1.3.5', '场景状态变化', '检查场景是否能基于提示词发生真实变化，如开关、破裂、雨水痕迹或整洁度变化'),
      node('1.3.6', '物理与自然现象', '检查雨雪、烟雾、火焰、液体、风等物理或自然现象是否可信'),
    ]),
    node('1.4', '表演与动作', '', [
      node('1.4.1', '动作执行', '检查走路、转身、坐下、抬手、奔跑、舞蹈、打斗、追逐等动作是否按提示自然、连贯、可信地完成'),
    ...
    node('1.5', '调度与场面组织', '', [
      ...
      node('1.5.3', '出入画与运动动线', '检查角色进出画面和移动路线是否自然、可追踪'),
    ]),
    node('1.6', '镜头语言', '', [
